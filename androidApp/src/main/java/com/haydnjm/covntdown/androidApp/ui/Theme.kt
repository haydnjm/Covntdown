...
private val appFontFamily = FontFamily(
    fonts = listOf(
        Font(resId = R.font.ubuntu_regular, weight = FontWeight.Medium, FontStyle.Normal)
    )
)
...
@Composable
fun CovntdownTheme(darkTheme: Boolean = isSystemInDarkTheme(), content: @Composable() () -> Unit) {
